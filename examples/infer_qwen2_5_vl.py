...
def main():
    ...
    parser.add_argument(
        ...
        help="3B is plenty for a sanity check; switch to 7B for full fidelity",
    )
    ...
    if args.ratio < 1.0:
        print(f"Applying Fourier Compressor to Qwen2.5-VL with ratio={args.ratio}...")
        apply_to_qwen2_5_vl(model, processor, ratio=args.ratio)
